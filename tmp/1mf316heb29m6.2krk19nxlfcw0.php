							...
							<div class="commentWrapperContent">
								...
								<div class="comment-insert">
									...
									<div class="comment-insert-container">
										...
										<textarea class="comment-insert-text" rows="4" cols="4">Tryp;lkdfj</textarea>
										<input type= "text" name="firstname" size="40" maxlength="40" placeholder="First Name" required="true" id="firstname" >
                          ...
                          <div class="modal-dialog modal-lg">
                            <div class="modal-content" id="modalcontent_details">
                                ...
                                <!--Add context here-->
						                         ...
						                         <!-- event modal -->
                        <div class="modal fade comments<?= ($event['event_id']) ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                          <div class="modal-dialog modal-lg">
                            <div class="modal-content" id="modalcontent_details">
                                 <img src="img/<?= ($event['image']) ?>" />
