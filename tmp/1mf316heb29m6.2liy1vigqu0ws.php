               ...
               <div id="wrapper">
                ...
                <div class="modal fade login" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-lg">
                    <div class="modal-content" id="modalcontentFront">
                     ...
                     <form action="./registerDB" method="post" enctype="multipart/form-data">
                         <fieldset>
                          <legend>
                             ...
                             <img src="hardCodedImages/dsfa.png" />
                          </legend>
                         </fieldset>
                       ...
                       <div id="signupContent">
                        ...
                        <div class="input-group">
                            <span class="input-group-addon">First Name</span><input type= "text" name="firstname" size="40" maxlength="40" placeholder="First Name" required="true" id="firstname" >
                         </div>
                        
                        <div class="input-group">
                         <span class="input-group-addon">Username</span><input type= "text" name="username" size="40" maxlength="40" placeholder="Username, Homie." required="true" id="username" >
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <input type= "password" name="password" size="20" maxlength="40" placeholder="Password" required="true" id="password">
                         </div>
