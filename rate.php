<html>
    <head>
        ...
        <link href= "css/rate_grid.css" rel="stylesheet" type="text/css">
    ...
    <body>
        ...
        <header>
            <?php include('inc/frontend_nav.php') ?>
        </header>
        <div id="wrappertwo">  
            <div id="columns">
                <div class="grid">
                        ...
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7c/Seattlenighttimequeenanne.jpg/449px-Seattlenighttimequeenanne.jpg" />
                         ...
                         <!-- signup modal -->
                      <button class="btn btn-primary" data-toggle="modal" data-target=".details" id="details">Details</button>
        ...
        <?php include('inc/bootstrap_jquery.php') ?>    
    </body>
</html>